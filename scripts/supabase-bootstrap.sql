-- ============================================================================
-- AppCitas · Bootstrap para Supabase (pegar en SQL Editor y pulsar RUN)
-- Hace tres cosas, en orden:
--   1. Crea el esquema completo (equivalente a "prisma migrate deploy")
--   2. Activa Row Level Security en todas las tablas: la API REST publica de
--      Supabase (PostgREST + anon key) NO podra leer tus datos. La app no se
--      ve afectada (conecta como propietaria de las tablas via Prisma).
--   3. Registra la migracion en _prisma_migrations para que futuros
--      "prisma migrate deploy" la reconozcan como aplicada.
-- Es idempotente a nivel de ejecucion unica: no lo ejecutes dos veces.
-- ============================================================================
...
-- 2. Hardening: RLS activado (sin politicas = acceso denegado via API publica)
ALTER TABLE "User" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "AuthToken" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "Business" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "Coupon" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "Package" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "ClientPackage" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "AuditLog" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "StaffMember" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "StaffHour" ENABLE ROW LEVEL SECURITY;
...
-- 3. Contabilidad de migraciones de Prisma
...
VALUES ('d78746f1-a66f-4a95-875b-65390d1d1b0b', '1f06ee7ebcea40782c6c7ab6e62c206142b076f8226bf6c7605f4dd272ac4182', '20260702000000_init', now(), 1);
