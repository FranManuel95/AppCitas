...
const es = {
  ...
  admin: {
    ...
    equipo: {
      ...
      serviceOverrideDuration: "Duración propia (min)",
      serviceOverridePrice: "Precio propio (€)",
...
const en: Dict = {
  ...
  admin: {
    ...
    equipo: {
      ...
      serviceOverrideDuration: "Own duration (min)",
      serviceOverridePrice: "Own price (€)",
