          ...
          <aside className="space-y-6">
            ...
            <div className="card border-amber-200 bg-amber-50">
              ...
              <p className="mt-2 text-sm text-amber-800">
                ...
                <strong>{business.cancellationWindowHours} horas</strong> antes
                de la cita. Pasado ese plazo se cobrará el{" "}
                <strong>{business.lateCancellationFeePercent}%</strong> del
                precio del servicio.
              </p>
            </div>
          </aside>
