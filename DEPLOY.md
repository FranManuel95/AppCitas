...
4. **Sin acceso directo al puerto 5432** (red corporativa, sandbox…): pega el
   ...
   incrementales `scripts/supabase-migration-2-*.sql` … `-10-*.sql` (cada uno
   ...
   consentimiento, el default de suscripción, los índices de camino caliente y
   los índices de trigramas de la búsqueda). Son idempotentes: registran su
   propia entrada en `_prisma_migrations`.
