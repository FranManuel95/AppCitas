...
4. **Sin acceso directo al puerto 5432** (red corporativa, sandbox…): pega el
   ...
   incrementales `scripts/supabase-migration-2-*.sql` … `-9-*.sql` (cada uno
   ...
   consentimiento, el default de suscripción y los índices de camino
   caliente). Son idempotentes: registran su propia entrada en
   `_prisma_migrations`.
