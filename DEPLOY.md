...
4. **Sin acceso directo al puerto 5432** (red corporativa, sandbox…): pega el
   ...
   incrementales `scripts/supabase-migration-2-*.sql` … `-22-*.sql` (cada uno
   ...
   los índices de trigramas de la búsqueda, la lista de espera, la forma de
   pago de la cita, la cuenta conectada de Stripe Connect, la señal al
   ...
   plataforma, las cuentas de invitado, las ausencias por empleado y las
   citas recurrentes). Son
