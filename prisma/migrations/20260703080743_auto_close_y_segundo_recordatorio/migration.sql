...
INSERT INTO "new_Business" ("active", "address", "cancellationWindowHours", "category", "createdAt", "currency", "description", "email", "id", "lateCancellationFeePercent", "maxAdvanceBookingDays", "minNoticeMinutes", "name", "notifyByEmail", "notifyBySms", "notifyByWhatsapp", "phone", "reminderHoursBefore", "remindersEnabled", "requireCardToBook", "slotGranularityMinutes", "slug", "taxId", "taxPercent", "timezone", "updatedAt") SELECT "active", "address", "cancellationWindowHours", "category", "createdAt", "currency", "description", "email", "id", "lateCancellationFeePercent", "maxAdvanceBookingDays", "minNoticeMinutes", "name", "notifyByEmail", "notifyBySms", "notifyByWhatsapp", "phone", "reminderHoursBefore", "remindersEnabled", "requireCardToBook", "slotGranularityMinutes", "slug", "taxId", "taxPercent", "timezone", "updatedAt" FROM "Business";
DROP TABLE "Business";
